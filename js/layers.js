addLayer("in", {
    ...
    buyables: {
        11: {
            title: 'Investments',
            cost(x) {
                return (player.points.mul(new Decimal(0.1).add(new Decimal(0.015).mul(x+1))).add(new Decimal(215).mul(2**x)).ceil())
            },
            display () {
                ...
                return (
                    ...
                    "<br><br>((215 * 2^x) + (1.5*x) % of funds)<br><br> -- not functional +2% fund gain"
                )
