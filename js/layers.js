    ...
    buyables: {
        11: {
            ...
            cost(x) {
                ...
                return (player.points.root(new Decimal(1.5))).add(new Decimal(215).mul(new Decimal(1.5).pow((getBuyableAmount(this.layer, this.id))))).ceil()
            },
            display () {
                const amount = getBuyableAmount(this.layer, this.id)
                ...
                return (
                    ...
                    "<br><br>((215 * 1.5^x) + (player points to the 1.5th root))<br><br> +5% fund gain"
                )
